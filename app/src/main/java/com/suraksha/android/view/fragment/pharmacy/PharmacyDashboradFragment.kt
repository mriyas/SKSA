...
import com.suraksha.app.databinding.FragmentPharmacyDashboardBinding


class PharmacyDashboradFragment : Fragment() {

    private lateinit var binding: FragmentPharmacyDashboardBinding
    ...
    override fun onCreateView(
        ...
        binding= FragmentPharmacyDashboardBinding.inflate(inflater,container,false)
        return binding.root
    }
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String) =
            PharmacyDashboradFragment().apply {
