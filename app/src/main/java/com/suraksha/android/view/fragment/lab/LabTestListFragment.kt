...
@AndroidEntryPoint
class LabTestListFragment : BaseFragment() {

    lateinit var mBinding: FragmentLabTestListBinding
    private val mAdapter = UniversalRecyclerViewAdapter<LabTest>(null, R.layout.rv_lab_tests)
    ...
    private fun setRecyclerView() {
        ...
        mLabsViewModel.getLabTests(0, 100)
        observeData()
    }
            ...
            mLabsViewModel.apiState.collect {
                ...
                when (it.status) {
                    ...
                    ApiState.Status.SUCCESS -> {
                        ...
                        val data = it.data
                        if (data is List<*>) {
                            mAdapter.setData(data as List<LabTest>?)
                        }
                    }
