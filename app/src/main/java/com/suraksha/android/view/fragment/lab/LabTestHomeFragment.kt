...
class LabTestHomeFragment : BaseFragment() ,
NavigationView.OnNavigationItemSelectedListener{

    private lateinit var binding: FragmentLabTestsHomeBinding
    ...
    override fun onCreateView(
        ...
        binding= FragmentLabTestsHomeBinding.inflate(inflater,container,false)
        return binding.root
    }
